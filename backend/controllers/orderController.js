...
const placOrder = async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: "payment",
            success_url: `https://frontend-8jj4.onrender.com/verify?success=true&orderId=${newOrder._id}`,
            cancel_url: `https://frontend-8jj4.onrender.com/verify?success=false&orderId=${newOrder._id}`,
        });
